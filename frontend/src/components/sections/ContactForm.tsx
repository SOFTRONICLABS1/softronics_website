...
const ContactForm: FC = () => {
  ...
  return (
    <section className="w-full flex justify-center items-center py-8 sm:py-12 md:py-16 relative overflow-hidden" style={{
      ...
      <div className="rounded-lg sm:rounded-xl shadow-xl flex flex-col md:flex-row w-[95%] sm:w-[90%] max-w-5xl overflow-hidden relative z-10" style={{
        ...
        <div className="flex-1 p-4 sm:p-6 md:p-8">
          <h2 className="text-xl sm:text-2xl font-bold mb-2 text-gray-800">How can we help you?</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:gap-4">
            ...
            <div className="mt-2 sm:mt-4">
              <button className="text-white border-2 border-transparent px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-300 w-full sm:w-auto min-h-[44px] shadow-lg hover:shadow-xl transform hover:-translate-y-0.5" style={{
                background: "linear-gradient(135deg, #4ECCEF 0%, #4ECCEF 100%)",
                boxShadow: "0 4px 15px rgba(255, 165, 0, 0.3)"
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "linear-gradient(135deg, #4ECCEF 0%, #4ECCEF 100%)";
        ...
        {/* Right: Person Info */}
        <div className="w-full md:w-[280px] flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 text-center relative" style={{
          ...
          <h3 className="font-semibold text-base sm:text-lg text-white">Chetan G</h3>
